...
int main(int argc, char** argv)
{
  ...
  string samples      = "406009,ZZ,WZ,WW,singleTop,ttbar,Z,W"; vector<string> sampleList    ;
  ...
  plots->setInputFile("/gdata/atlas/amete/Summer2015AnalysisRun/HFTs/mc15_13TeV.root");
