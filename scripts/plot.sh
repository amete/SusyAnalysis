#!/bin/bash
generator="sherpa"
mkdir -p /data/uclhc/uci/user/amete/analysis_n0224_run/EWK2L/figures_4/${generator};
cd /data/uclhc/uci/user/amete/analysis_n0224_run/EWK2L/figures_4/${generator};
