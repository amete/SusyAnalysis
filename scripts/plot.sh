...
plotFigures --regions SR2LpreMT2 --channels sf,em --variables mT2lep --binValues 20,0,200  --plotLog;
#plotFigures --regions SR2LpreMT2 --channels sf,em --variables drll   --binValues 20,0,10      --plotLog;
#plotFigures --regions SR2LpreMT2 --channels sf,em --variables dphill --binValues 35,-3.5,3.5  --plotLog;
